...
import { useGetSingleGeneralUserQuery } from "@/redux/api/generalUserApi";
import Image from "next/image";

const EditGeneralUserPage = ({ params }: any) => {
  const { data: adminData, isLoading: loading } = useGetSingleGeneralUserQuery(
    params?.id
  );
...
export default EditGeneralUserPage;
